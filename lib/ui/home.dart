...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar (title: Container(height: 41.h,width: 350.w,
      child: TextField(controller: search,style: TextStyle(color: Colors.white),
        ...
        onSubmitted: (value) {BlocProvider.of<InstaBloc>(context).add(Fetchinsta(name: search.text));
        BlocProvider.of<HighlightBloc>(context).add(fetchhihglight(name: search.text));
        BlocProvider.of<PostBloc>(context).add(Fetchpost(name: search.text));
        BlocProvider.of<TagBloc>(context).add(fetchtag(name: search.text));
                ...
                return RefreshIndicator(
                    ...
                    onRefresh: () async {
                      return BlocProvider.of<InstaBloc>(context)
                          .add(Fetchinsta(name: search.text));
                    });
              }
                                  ...
                                  return RefreshIndicator(
                                      ...
                                      onRefresh: () async {
                                        return BlocProvider.of<HighlightBloc>(
                                                context)
                                            .add(fetchhihglight(name: search.text));
                                      });
                                }
