...
class Following  {
  ...
  Following({this.data, this.paginationToken});
  ...
  static List<Following> fromList(List<Map<String, dynamic>> list) {
    return list.map((map) => Following.fromJson(map)).toList();
  }
...
class Items {
  ...
  Items({this.fullName, this.id, this.isPrivate, this.isVerified, this.profilePicUrl, this.username});
